		<footer class="clear">
			...
			<div class="social">
				<h3>Social</h3>
				<a href="#"><figure class="fa fa-facebook"></figure>Facebook</a>
				<a href="#"><figure class="fa fa-twitter"></figure>Twitter</a>
				<a href="#"><figure class="fa fa-rss"></figure>Rss Feed</a>
			</div>


			<div class="branding">
				<figure role="img" class="logo"></figure>
	...
	<script type="text/javascript">
		...
		$("header .main-social .contact, footer .svg-container").click(function() {
	...
	<script type="text/javascript">
	/* <![CDATA[ */ 
	var google_conversion_id = 864951207; 
	...
	<img height="1" width="1" style="border-style:none;" alt="" src="//googleads.g.doubleclick.net/pagead/viewthroughconversion/864951207/?guid=ON&script=0"/>
	</div>
